...
declare namespace FBInstant {
    ...
    interface FBPlayer {
         ...
         * Returns Promise<Array<ConnectedPlayer>> A promise that resolves with a list of 
         * connected player objects. NOTE: This function should not be called until 
...
type FBContextFilter = "NEW_CONTEXT_ONLY" | "INCLUDE_EXISTING_CHALLENGES" | "NEW_PLAYERS_ONLY";
type FBPlatform = "IOS" | "ANDROID" | "WEB" | "MOBILE_WEB";
type FBContextType = "POST" | "THREAD" | "GROUP" | "SOLO"
type FBShareIntent = "INVITE" | "REQUEST" | "CHALLENGE" | "SHARE"
